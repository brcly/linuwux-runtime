...
pub const OVERRIDES: [&CStr; 13] = [
    c"winmm", c"version", c"reflex", c"d3d9", c"d3d10", c"d3d11", c"d3d12", c"dinput8", c"dsound",
    c"dxgi", c"hid", c"wininet", c"winhttp",
];

pub fn already_present(existing: &[u8], dll: &[u8]) -> bool {
    dll.is_empty() || existing.windows(dll.len()).any(|part| part == dll)
}
